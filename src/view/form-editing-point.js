...
const createPointEditingFormTemplate = (point) => {
  const {date, cityName, eventType, eventIcon, description, timeStart, timeFinish, additionalOptions, price} = point;
  ...
  const createOffersTemplate = (offers) => {
    if (additionalOptions.length === 0) {
      ...
      offers.forEach((item, index) => {
        ...
        offersTemplte.push(`<div class="event__offer-selector">
              ...
              <form class="event event--edit" action="#" method="post">
                <header class="event__header">
                  ...
                  <div class="event__field-group  event__field-group--time">
                    ...
                    <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${dateFormat} ${timeStart}">
                    &mdash;
                    <label class="visually-hidden" for="event-end-time-1">To</label>
                    <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${dateFormat} ${timeFinish}">
                  </div>
...
export default class PointEditingForm extends Abstract {
  ...
  getTemplate() {
    return createPointEditingFormTemplate(this._point);
  }

  _editSubmitHandler(evt) {
    evt.preventDefault();
    this._callback.editSubmit(this._point);
  }
